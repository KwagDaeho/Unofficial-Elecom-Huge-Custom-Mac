...
pub use emit::{emit_activator_from_hid, emit_combo_trigger_huge, emit_gesture_canvas_phase};
pub use session::{
    ...
    set_combo_trigger_capture, set_gesture_ball_stroke_active, set_gesture_canvas_drawing,
    set_key_capture, set_ui_modal,
    ui_modal_active, gesture_ball_stroke_active, gesture_canvas_drawing, gesture_record_active,
};
