...
# Korean Finder name
/usr/libexec/PlistBuddy -c "Set :CFBundleName 설치하기" "$APP/Contents/Info.plist" 2>/dev/null \
  || /usr/libexec/PlistBuddy -c "Add :CFBundleName string 설치하기" "$APP/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Set :CFBundleDisplayName 설치하기" "$APP/Contents/Info.plist" 2>/dev/null \
  || /usr/libexec/PlistBuddy -c "Add :CFBundleDisplayName string 설치하기" "$APP/Contents/Info.plist"
