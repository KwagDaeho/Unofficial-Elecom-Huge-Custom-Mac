import { DEFAULT_GESTURE_MIN_SCORE } from "@/domain/gesture";
import { ballScrollOf, activatorsEqual } from "./activator";
...
export const gestureEntryIsValid = (entry: GestureMappingEntry): boolean =>
  entry.holdActivator !== null && entry.template.length >= 8;
